...
namespace EmeraldAI.Utility
{
    ...
    public class EmeraldAIEditor : Editor
    {
        ...
        SerializedProperty HealthBarPosProp, NameTextFontSizeProp, HealthBarScaleProp, BloodPosOffsetProp, AINamePosProp, AILevelPosProp, DetectionLayerMaskProp, ObstructionDetectionLayerMaskProp,
            AlignmentLayerMaskProp, AIAvoidanceLayerMaskProp, UILayerMaskProp, AINameUIOutlineSizeProp, AILevelUIOutlineSizeProp, DynamicWanderLayerMaskProp;
        ...
        SerializedProperty DeathEventProp, DamageEventProp, ReachedDestinationEventProp, OnStartEventProp, OnAttackEventProp, OnFleeEventProp, OnStartCombatEventProp, OnEnabledEventProp,
            OnPlayerDetectionEventProp, OnKillTargetEventProp, OnDoDamageEventProp, OnHealEventProp, OnCriticalHitEventProp, OnAttackEndEventProp;
            ...
            MeleeAttacks.drawElementCallback =
                (Rect rect, int index, bool isActive, bool isFocused) => {
                    ...
                    if (self.RandomizeDamageRef == EmeraldAISystem.RandomizeDamage.Yes)
                    {
                        ...
                        element.FindPropertyRelative("ReactionID").intValue = EditorGUI.IntField(new Rect(rect.x, rect.y + 85, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent("Reaction ID", "The maximum damage this attack can do."), element.FindPropertyRelative("ReactionID").intValue);
                        EditorGUI.BeginDisabledGroup(self.MeleeAttackPickType != EmeraldAISystem.MeleeAttackPickTypeEnum.Odds);
                        element.FindPropertyRelative("AttackOdds").intValue = EditorGUI.IntSlider(new Rect(rect.x, rect.y + 110, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent("Attack Odds",
