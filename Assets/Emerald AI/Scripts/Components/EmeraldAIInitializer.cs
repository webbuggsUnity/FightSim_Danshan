...
namespace EmeraldAI.Utility
{
    public class EmeraldAIInitializer : MonoBehaviour
    {
        ...
        void CheckFactionRelations ()
        {
            ...
            {
                Debug.LogWarning("The AI '" + gameObject.name + "' contains an Enemy Faction Relation of its own Faction '" + EmeraldComponent.EmeraldEventsManagerComponent.GetFaction() + 
